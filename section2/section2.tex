...
\vfill
    ...
    & \hspace{0.1cm} \Lbdun=0 \text{~~ on $\textcolor{\myred}{\boldsymbol{\Gamma_1}}$} \\
    & \hspace{0.1cm}  \Lbdun-\velocity \density \Lbdeux \cdot \normal=0 \text{~~ on $\textcolor{\myblue}{\boldsymbol{\Gamma_2}}$}\\
...
\begin{frame}{Discretize then Optimize Strategy}
...
%            \dotfill
      ...
      \item[\textcolor{black}{\textbullet}] Non-physical consistency of the adjoint state \footnotemark
      \end{itemize}
      }
    \end{column}
  \end{columns}
